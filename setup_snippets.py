...
path_wya_codesnippets = os.getcwd()  # 获取源文件地址
print("%s"%path_wya_codesnippets)
filelist = os.listdir(path_wya_codesnippets)
print (filelist)
path2 = path_wya_codesnippets.replace('WYACodeSnippets','')   # 需要复制到的文件夹
...
for files in filelist:
    ...
    if m:
        ...
        despath = path2 + filename0 + '.codesnippet'  # 为你的文件类型，即后缀名，读者自行修改
